...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label9.Text = "BUILD 20060213.3"
        ...
        Me.CommunicationLabel2.Text = "Once you have selected the assignment you wish to hand-in for, simply click on th" & _
        "e ‘Proceed’ button. This screen will then be replaced with a simple Explorer-lik" & _
        "e window that will allow you to upload the necessary files to the server."
        '
        'CommunicationLabel1
        '
        ...
        Me.CommunicationLabel1.Text = "To launch the File Hand-in controller, you first need to select the assignment yo" & _
        "u wish to hand-in for. To do this you need to select the appropriate department," & _
        " course and project from the drop down lists presented below. The lists have bee" & _
        "n populated according to what courses you are registered for as well as what ass" & _
        "ignments are currently active and accepting hand-ins. Should you not be able to " & _
        "locate what you are looking for in the lists, please contact your course supervi" & _
        "sor immediately so that they can rectify the problem."
        '
        'GroupBox1
        '
    ...
    Private Sub Main_Screen_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            If Current_User.Text.StartsWith("Unknown") = False Then
                Dim cresult As String = Worker1.UserGroups(Current_User.Text, "Students.com.main.uct")
                ...
                For Each dinfo2 In dinfo.GetDirectories
                    ...
                    Else
                        ...
                        If opentime.Length = 12 And closetime.Length = 12 Then
                            opendate = New Date(opentime.Substring(0, 4), opentime.Substring(4, 2), opentime.Substring(6, 2), opentime.Substring(8, 2), opentime.Substring(10, 2), 0, 0)
                            closedate = New Date(closetime.Substring(0, 4), closetime.Substring(4, 2), closetime.Substring(6, 2), closetime.Substring(8, 2), closetime.Substring(10, 2), 0, 0)
